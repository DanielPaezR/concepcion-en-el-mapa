...
export default function MisReservas() {
    ...
    const getEstadoInfo = (estado) => {
        switch(estado) {
            case 'pendiente': 
                return { icon: <Clock className="w-5 h-5 text-yellow-500" />, text: 'Pendiente', color: 'bg-yellow-100 text-yellow-800' };
            case 'confirmada': 
                return { icon: <CheckCircle className="w-5 h-5 text-green-500" />, text: 'Confirmada', color: 'bg-green-100 text-green-800' };
            case 'completada': 
                return { icon: <CheckCircle className="w-5 h-5 text-blue-500" />, text: 'Completada', color: 'bg-blue-100 text-blue-800' };
            case 'cancelada': 
                return { icon: <XCircle className="w-5 h-5 text-red-500" />, text: 'Cancelada', color: 'bg-red-100 text-red-800' };
            default: 
